...
import cs3714.hw4.network.IsUserLoggedInAsyncTask;
import cs3714.hw4.service.BackgroundService;
...
public class TaskFragment extends Fragment implements RetainedFragmentInteraction {
    ...
    public void startBackgroundServiceNeeded() {
        ...
        if (!isBackgroundServiceRunning()) {
            Intent intent = new Intent(TaskFragment.this.getActivity(), BackgroundService.class);
